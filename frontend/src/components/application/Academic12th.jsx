...
function Academic12th({ handleChange }) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-12 gap-4 items-end">
        ...
        <div className="col-span-3">
          ...
          <input
            type="text"
            name="twelfth_equi_exam_passed"
            value="12th/Equivalent"
            readOnly
        ...
        <div className="col-span-3">
          ...
          <input
            type="text"
            name="twelfth_equi_school_name"
            maxLength="100"
            placeholder="(100 char max) School Name"
            required
            className="input mt-1"
        ...
        <div className="col-span-3">
          ...
          <select
            name="twelfth_equi_passing_year"
            required
            className="input mt-1"
            onChange={handleChange}
          >
      ...
      <div className="grid grid-cols-12 gap-4 items-end">
        ...
        <div className="col-span-3">
          ...
          <select
            name="twelfth_equi_complete_status"
            required
            className="input mt-1"
            onChange={handleChange}
          >
        ...
        <div className="col-span-3">
          ...
          <input
            type="text"
            name="twelfth_equi_notes_if_any"
            maxLength="200"
